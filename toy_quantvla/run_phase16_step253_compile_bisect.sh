...
TAG="${TAG:-phase16_step253_compile_bisect_v1}"
...
TARGETS="${TARGETS:-action_head_model action_head_model_blocks_0_15_eager action_head_model_blocks_0_7_eager action_head_model_blocks_0_3_eager action_head_model_blocks_4_7_eager action_head_model_blocks_8_15_eager action_head_model_attn_all_eager action_head_model_ff_all_eager action_head_dit_attn_all}"
...
echo "Phase 16.6 step253 compile bisect complete"
