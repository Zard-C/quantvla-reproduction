...
\begin{table*}[t]
\centering
\caption{Multi-fold tactic selection on two held-out 30-case folds. Fold A uses initial states 15--17 and Fold B uses 18--20. Regressions are counted against FP16 on matched task-initialization pairs.}
