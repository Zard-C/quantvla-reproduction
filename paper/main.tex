...
\paragraph{Claim 3: offline drift is incomplete without state-distribution control.}
...
\paragraph{Claim 4: aggregate success differences decompose exactly into repairs and regressions.}
...
\midrule
Sensitivity-weighted perturbation &
...
\addlinespace
Repair/regression decomposition &
...
\addlinespace
Anisotropic closed-loop sensitivity &
