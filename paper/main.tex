...
\end{enumerate}
This converts acceleration from a search for a single numerically closest implementation into an iterative exploration of the closed-loop solution space. Algorithm~\ref{alg:closed-loop-tactic-search} summarizes the resulting heuristic.
