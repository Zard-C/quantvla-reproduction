...
\textbf{Algorithm 1: Closed-Loop Sensitivity-Guided Tactic Search (CLSG-TS)}
\begin{enumerate}
    ...
    \item \textbf{Output:} a behavior-first tactic or a speed-constrained Pareto tactic, with its matched success, regression, and latency report.
\end{enumerate}
\end{minipage}}
